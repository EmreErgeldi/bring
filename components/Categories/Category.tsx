  ...
  return (
    <div className="bg-white py-4">
      <div className="container mx-auto">
        <h3 className="font-semibold text-[15px] mb-2 w-[1232px] mx-auto">
          Categories
        </h3>
        <div className="grid grid-cols-3 sm:grid-cols-6 md:grid-cols-8 lg:grid-cols-10 gap-y-2 w-[1232px] mx-auto text-slate-600">
          {data &&
            data.map((category, i) => (
              <a
                href="#"
